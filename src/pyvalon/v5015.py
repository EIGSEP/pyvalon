...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="The reference source('internal' or 'external' or 'status')",
    )
    parser.add_argument(
        "--rfout",
        dest="rfout",
        type=str,
        default="",
        help="The rfout status('on' or 'off'  or 'status')",
    )
    parser.add_argument(
        "--pwr",
        dest="pwr",
        type=str,
        default="",
        help="The power status('on' or 'off'  or 'status')",
    )
    parser.add_argument(
        "--v",
        dest="verbose",
